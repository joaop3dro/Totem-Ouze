...
type
  ...
  public
    ...
    class function ClearSection(const AFilePath, AFileName, ASection: string): Boolean;
    class function ReadIni(const AFilePath, AFileName, ASection, AIdent, AValue: string): String;
    class function ReadIniInt(const AFilePath, AFileName, ASection, AIdent, AValue: string): Integer;
    class function ReadIniBool(const AFilePath, AFileName, ASection, AIdent, AValue: string): Boolean;
    class function WriteIni(const AFilePath, AFileName, ASection, AIdent, AValue: string): Boolean;
  private
  end;
...
class function TManageIniFile.ClearSection(const AFilePath, AFileName,
  ...
  begin
    try
      vIniFile := TIniFile.Create(System.IOUtils.TPath.Combine(AFilePath,
        AFileName));
      vIniFile.EraseSection(ASection);
      Result := True;
    finally
      FreeAndNil(vIniFile);
    end;
