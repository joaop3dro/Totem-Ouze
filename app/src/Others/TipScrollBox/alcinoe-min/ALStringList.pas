...
Type
  ...
  public
    ...
    procedure AddStrings(Strings: TALStrings); overload; override;
    procedure Assign(Source: TPersistent); override;
...
type
  ...
  public
    ...
    procedure AddStrings(Strings: TALStringsU); override;
...
procedure TALStringList.AddStrings(Strings: TALStrings);
var
  I: Integer;
begin
  if not Sorted or
     (Count = 0) and (Strings is TALStringList) and
     TALStringList(Strings).Sorted and
     (CaseSensitive = TALStringList(Strings).CaseSensitive) and
     (Duplicates = TALStringList(Strings).Duplicates) then
  begin
    BeginUpdate;
    try
      for I := 0 to Strings.Count - 1 do
...
procedure TALStringListU.AddStrings(Strings: TALStringsU);
var
  I: Integer;
begin
  if not Sorted or
     (Count = 0) and (Strings is TALStringListU) and
     TALStringListU(Strings).Sorted and
     (CaseSensitive = TALStringListU(Strings).CaseSensitive) and
     (Duplicates = TALStringListU(Strings).Duplicates) then
  begin
    BeginUpdate;
    try
      for I := 0 to Strings.Count - 1 do
