      ...
      begin
        ...
        begin
          ...
          begin
            ...
            begin
              FMSG.Show(TIconDialog.Warning, 'Atenção','Conta bloqueada, favor dirigir-se ao espaço Ouze.','OK');
              result := false;
              exit;
            end
            else
            begin
              FMSG.Show(TIconDialog.Warning, 'Atenção','Conta com problema, favor dirigir-se ao espaço Ouze.','OK');
              result := false;
              exit;
            end;
          end;
