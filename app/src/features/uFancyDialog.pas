...
const
    ...
    ColorBlue : Cardinal = $FF00ADEA;
    ColorOrange : Cardinal = $FFF3A867;
    ColorRose: Cardinal = $FFE400E4;
    ColorPurple : Cardinal = $FF323F70;
...
begin
    ...
    RectMsg.Width := Frm.Width /2;
    RectMsg.Height := Frm.Height - 200;
...
begin
    ...
    begin
        Arco.Stroke.Color := ColorRose;
        RectIcon1.Fill.Color := ColorRose;
        RectIcon2.Fill.Color := ColorRose;
        LabelIcon.FontColor := ColorRose;
    end
