...
type
  TLoading = class
    ...
    public
          ...
          class procedure ToastMessage(const Frm : Tform; const msg: string; const duracao: integer;
                                      alinhamento: TAlignLayout = TAlignLayout.MostRight;
                                      cor_fundo: Cardinal = $FFE400E4;
...
class procedure TLoading.ToastMessage(const Frm : Tform; const msg: string; const duracao: integer;
                                      alinhamento: TAlignLayout = TAlignLayout.MostRight;
                                      cor_fundo: Cardinal = $FFE400E4;
                                      cor_fonte: Cardinal = $FFFFFFFF);
var
...
begin
        ...
        FundoToast.Width := 296;
        FundoToast.Margins.Left := 0;
        FundoToast.Margins.Right := 10;
        FundoToast.Margins.Bottom := 10;
        FundoToast.Margins.Top := Frm.Height * 0.8;
        FundoToast.Fill.Color := cor_fundo;
        FundoToast.Fill.Kind := TBrushKind.Solid;
        FundoToast.Stroke.Kind := TBrushKind.None;
        FundoToast.XRadius := 10;
        FundoToast.YRadius := 10;
